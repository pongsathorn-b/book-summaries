...
[[Barbara Oakley]] was a language major who struggled with math — then discovered she's not "bad at math," she'd just never learned how to learn. She went on to co-create one of the world's most popular online courses.
...
- Novices see bits; [[Experts]] see chunks
- [[Chunk Building]] requires: focused study, understanding, practice with [[Retrieval]]
- Context (when and how to use a chunk) is as important as the chunk itself

### [[The Illusion of Knowing]]

Rereading and highlighting create the illusion of mastery. [[Recognition vs Recall]]: recognition is not recall.
