---
tags: [productivity, prioritization, procrastination, time-management]
category: Productivity
summary: Identify your single most important task each day and tackle it first — willpower is a finite morning resource that evaporates through the day.
---

# Eat That Frog! — Brian Tracy

> "If you have to eat a frog, don't spend a lot of time looking at it. If you have to eat two, start with the larger one."
...
- **The Frog** — Your single most important task of the day. The one task that, if completed, makes everything else easier or unnecessary.
- **Eat It First** — Never check email, news, or social media before eating your frog. Your morning willpower is your most valuable resource.
- **The ABCDE Method** — Prioritize your daily list before starting:
  - A = Must do (severe consequences if not done)
  - B = Should do (mild consequences)
  - C = Nice to do (no consequences)
  - D = Delegate
  - E = Eliminate
- **The 80/20 Rule** — 20% of tasks produce 80% of results. Focus on the critical 20%.
- **Technology is a Frog Eater** — Email, social media, and news are designed to fragment attention; avoid them until your frog is eaten
- **Chaining** — Link your frog task to a reward. Complete it, then enjoy your treat.

## Key Lessons

- Willpower is a depleting resource — the closer to morning, the stronger it is. Spend it on your hardest task first.
...
3. Use [[30 Knowledge/Concepts/the-pomodoro-technique|The Pomodoro Technique]] to eat your frog — 1-2 focused pomodoros on your hardest task
...
7. When facing multiple frogs, eat the ugliest/largest one first (Covey's Habit 2: begin with end in mind)

## Controversy / Criticism

- Oversimplification: the book offers motivational principles but minimal execution framework
- "Just do it" advice ignores executive function disorders (ADHD, anxiety) where task initiation is neurochemically impaired
- Some find the relentless productivity framing toxic — workaholism dressed up as efficiency
- The book is thin (120 pages of content) — critics call it a long blog post padded with examples
- Doesn't address the root causes of chronic procrastination or lack of clarity about what matters

## One-Line Takeaway

Willpower is a morning resource — eat your hardest, most important task first thing every day, before anything else consumes your attention.
